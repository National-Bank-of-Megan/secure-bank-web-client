...
const PasswordCharacterInput: React.FC<{ index: number, setCurrentIndex: (index: number) => void, setLetters: React.Dispatch<SetStateAction<string[]>>, inputRef: RefObject<HTMLInputElement> }> = (props) => {
    ...
    return (
        <Stack sx={{
            ...
            <OutlinedInput ref={props.inputRef} type="password" inputProps={{
